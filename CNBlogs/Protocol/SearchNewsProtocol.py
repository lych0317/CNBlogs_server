...
def search_news_keyword_page(keyword, page="0"):

    url = "http://zzk.cnblogs.com/s?t=n&dateMin=2013-01-01"
    if keyword:
        url = url + "&w=" + keyword
    if page:
        url = url + "&p=" + page
...
# print search_news_keyword_page("ios")
